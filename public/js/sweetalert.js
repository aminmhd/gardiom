!function (t, e) {
        ...
        ft = function (t) {
            if (!function () {
                ...
                n.appendChild(e), function (t) {
                    ...
                    var t = P(), e = lt(t, z.input), n = lt(t, z.file),
    ...
    var yt = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap},
        wt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Ct = function (t) {
            ...
            var e = Pt(t.input), n = At[t.input](e, t);
    ...
    function Bt(t, e) {
        ...
        e.html ? (rt(e.html, n), X(n, "block")) : e.text ? (n.textContent = e.text, X(n, "block")) : G(n), function (t, o) {
            var i = P(), e = yt.innerParams.get(t), r = !e || o.input !== e.input;
    ...
    function Et(t, e) {
        ...
        R(n, e, "header"), St(0, e), function (t, e) {
            ...
            if (n && e.icon === n.icon && k()) R(k(), e, "icon"); else if (Ot(), e.icon) if (-1 !== Object.keys(W).indexOf(e.icon)) {
    ...
    function Tt(t, e) {
        ...
        }(0, e), vt(0, e), Et(t, e), Bt(t, e), at(0, e), function (t, e) {
            var n = M();
    ...
    var Ot = function () {
        ...
        if (t.innerHTML = "", e.iconHtml) t.innerHTML = jt(e.iconHtml); else if ("success" === e.icon) t.innerHTML = '\n      <div class="swal2-success-circular-line-left"></div>\n      <span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span>\n      <div class="swal2-success-ring"></div> <div class="swal2-success-fix"></div>\n      <div class="swal2-success-circular-line-right"></div>\n    '; else if ("error" === e.icon) t.innerHTML = '\n      <span class="swal2-x-mark">\n        <span class="swal2-x-mark-line-left"></span>\n        <span class="swal2-x-mark-line-right"></span>\n      </span>\n    '; else {
    ...
    function te(t, e, n, o) {
        n ? ie(t, o) : (It().then(function () {
            return ie(t, o)
        }), Ft.keydownTarget.removeEventListener("keydown", Ft.keydownHandler, {capture: Ft.keydownListenerCapture}), Ft.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), I() && (null !== Y.previousBodyPadding && (document.body.style.paddingRight = "".concat(Y.previousBodyPadding, "px"), Y.previousBodyPadding = null), function () {
    ...
    function ee(t) {
        ...
        if (e) {
            ...
            if (n && !q(e, n.hideClass.popup)) {
                ...
                var i = y();
                st(i, n.showClass.backdrop), ut(i, n.hideClass.backdrop), function (t, e, n) {
    ...
    var ye = function (t, e) {
        ...
        }, Oe = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"], Me = ["Escape", "Esc"],
        He = function (t, e, n, o) {
    ...
    var Ke, Ye = Object.freeze({
        hideLoading: Zt, disableLoading: Zt, getInput: function (t) {
            ...
            var e = function (t) {
                var e = c({}, _t.showClass, t.showClass), n = c({}, _t.hideClass, t.hideClass), o = c({}, _t, t);
            ...
            return Tt(this, e), yt.innerParams.set(this, e), function (n, o, i) {
                return new Promise(function (t) {
                    var e = function t(e) {
